...
Catalog 是 Theme 布局能力的可执行规格：28 个逻辑场景生成 45 个物理 PDF 页面。它围绕完全
...
`catalog-verify` 同时验证 28/45 页契约、公共导入边界、原生内容接口、PDFPC 生命周期、
Footer 安全距离、单行标题与 30pt 下限，以及 288 DPI 下声明为稳定的渐进区域。第 43 页
...
sections/      直接导入 @local/systems-slides-template:0.4.0 的 28 个场景
